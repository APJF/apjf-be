...
VALUES
    ...
    ('course-01', NULL, NULL, NULL, 'COURSE', 'instructor-01', NOW() - INTERVAL '2 days', 'UPDATE', 'PENDING', NULL,
     NULL, NULL),
    (NULL, 'chapter-01', NULL, NULL, 'CHAPTER', 'instructor-02', NOW() - INTERVAL '1 days', 'CREATE', 'PENDING', NULL,
     NULL, NULL),
    (NULL, NULL, 'unit-05', NULL, 'UNIT', 'instructor-01', NOW() - INTERVAL '3 hours', 'UPDATE', 'PENDING', NULL, NULL,
     NULL),

    -- APPROVED requests (đã được Manager duyệt)
    ('course-02', NULL, NULL, NULL, 'COURSE', 'instructor-02', NOW() - INTERVAL '7 days', 'CREATE', 'APPROVED',
     'Khóa học chất lượng cao, nội dung phù hợp với learner path', 'manager-01', NOW() - INTERVAL '5 days'),
    (NULL, 'chapter-02', NULL, NULL, 'CHAPTER', 'instructor-01', NOW() - INTERVAL '10 days', 'CREATE', 'APPROVED',
     'Chương được thiết kế tốt với bài tập phong phú', 'manager-02', NOW() - INTERVAL '8 days'),

    -- REJECTED requests (đã bị Manager từ chối)
    (NULL, NULL, NULL, 'material-01', 'MATERIAL', 'instructor-03', NOW() - INTERVAL '15 days', 'UPDATE', 'REJECTED',
     'Chất lượng video chưa đạt yêu cầu, cần cải thiện âm thanh và hình ảnh', 'manager-01', NOW() - INTERVAL '12 days');

/* ---------- EXAM TEST DATA ---------- */

/* Questions */
INSERT INTO questions (id, content, correct_answer, type, explanation, file_url, created_at)
VALUES ('q1', 'Hiragana あ được đọc như thế nào?', 'a', 'MULTIPLE_CHOICE', 'あ được đọc là "a"', null, NOW()),
       ...
       ('q4', 'Tiếng Nhật có bao nhiêu chữ Hiragana cơ bản?', null, 'TRUE_FALSE', '46 chữ Hiragana cơ bản', null,
        NOW()),
...
VALUES ('exam1', 'Kiểm tra Hiragana cơ bản', 'Bài kiểm tra về chữ Hiragana', 30, 'CLASS', NOW()),
...
VALUES ('loc1', 'exam1', 'class-101', 'CLASS'),
...
VALUES ('result1', '2024-12-01 09:00:00', '2024-12-01 09:25:00', 8.5, 'PASSED', 'user1', 'exam1'),
       ...
       ('result4', '2024-12-01 10:00:00', null, null, null, 'user3', 'exam3');
-- Chưa nộp bài
